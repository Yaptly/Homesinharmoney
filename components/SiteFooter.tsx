  ...
  return (
    <footer className="hairline mt-24">
      <div className="max-w-6xl mx-auto px-6 py-14 grid gap-10 md:grid-cols-4">
        ...
        <div className="text-charcoal-soft space-y-3"><p className="tracked-caps text-sage-deep">Serving</p><p>Morgantown, Cheat Lake, Westover, Star City, Suncrest, Brookhaven, Granville &amp; Fairmont, WV</p><p><Link href="/service-areas" className="underline underline-offset-4">View service area</Link></p></div>
      </div>
